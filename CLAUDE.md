...
This project is indexed by GitNexus as **shuvoncho** (8589 symbols, 22049 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/shuvoncho/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/shuvoncho/context` | Codebase overview, check index freshness |
| `gitnexus://repo/shuvoncho/clusters` | All functional areas |
| `gitnexus://repo/shuvoncho/processes` | All execution flows |
| `gitnexus://repo/shuvoncho/process/{name}` | Step-by-step execution trace |
